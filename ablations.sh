...
torchrun --nproc_per_node=4 01_train.py --model-names logs/model1-shared-embeddings/final_state.pt logs/model2-shared-embeddings/final_state.pt --use-first-layer --savefile=2models-first-layer-shared-embeddings
### baseline: same model twice
torchrun --nproc_per_node=4 01_train.py --model-names logs/model1-shared-embeddings/final_state.pt logs/model1-shared-embeddings/final_state.pt --savefile=1model-twice-no-first-layer-shared-embeddings
torchrun --nproc_per_node=4 01_train.py --model-names logs/model1-shared-embeddings/final_state.pt logs/model1-shared-embeddings/final_state.pt --use-first-layer --savefile=1model-twice-first-layer-shared-embeddings