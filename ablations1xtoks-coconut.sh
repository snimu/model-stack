...
torchrun --nproc_per_node=8 01_train.py --train --coconut-every 10 --norm-wte rms_norm --norm-lm-head rms_norm --model-id=m1-rr-coconut-every-10 --seed=789363
torchrun --nproc_per_node=8 01_train.py --train --coconut-every 10 --norm-wte rms_norm --norm-lm-head rms_norm --model-id=m2-rr-coconut-every-10 --seed=223002 --from-model=m1-rr-coconut-every-10
